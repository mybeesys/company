@props(['active' => false])
<div class="tab-pane fade {{ $active ? 'show active' : '' }} screen-tab-pane" id="playlists_tab" role="tabpanel">
    <div class="screen-tab-header">
        ...
        @dashboardcan(\Modules\Screen\Support\ScreenPermissions::for('playlists', 'create'))
