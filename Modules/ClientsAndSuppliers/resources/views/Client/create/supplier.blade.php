...
@section('title', __('clientsandsuppliers::general.add_supplier'))
@section('css')
    <style>
...
@section('content')
    <form id="client" method="POST" action="{{ route('client-save') }}" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="business_type" value="supplier" />
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <h1> @lang('clientsandsuppliers::general.add_supplier')</h1>
                    ...
                    <div class="card" data-section="contact" style="border: 0;box-shadow: none">
                        <div class="container">
                            <div class="d-flex align-items-center mb-5">
                                <label class="fs-6 fw-semibold mb-2 me-3 required" style="width: 150px;">@lang('clientsandsuppliers::fields.supplier_name')
                                </label>
                                <input class="form-control form-control-solid custom-height" name="client_name" required
                                    placeholder="@lang('clientsandsuppliers::fields.supplier_name') / @lang('clientsandsuppliers::fields.organization_name')" id="client_name" type="text">
                            </div>
                            <div class="d-flex align-items-center mb-5">
...
@section('script')
    <script>
        ...
        document.getElementById('addContactCard').addEventListener('click', function() {
            ...
            // Show delete button for cloned cards
        ...
        // Hide delete button for the first card
