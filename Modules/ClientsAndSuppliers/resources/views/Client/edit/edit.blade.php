...
@section('title', __('clientsandsuppliers::general.edit_clients'))
@section('css')
    <style>
                        ...
                        <div class="container">
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <input class="form-control form-control-solid custom-height" name="client_name" required
                                    value="{{ $contact->name }}" placeholder="@lang('clientsandsuppliers::fields.client_name') / @lang('clientsandsuppliers::fields.organization_name')"
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <input class="form-control form-control-solid custom-height" name="mobile_number"
                                    placeholder="@lang('clientsandsuppliers::fields.mobile_number')" id="mobile_number" value="{{ $contact->mobile_number }}"
                                    type="text">
                            </div>
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <input class="form-control form-control-solid custom-height" name="phone_number"
                                    placeholder="@lang('clientsandsuppliers::fields.phone_number')" id="phone_number" value="{{ $contact->phone_number }}"
                                    type="text">
                            </div>
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <input class="form-control form-control-solid custom-height" name="email"
                                    placeholder="@lang('clientsandsuppliers::fields.email')" id="email" value="{{ $contact->email }}"
                                    type="text">
                            </div>
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <input class="form-control form-control-solid custom-height" name="website"
                                    placeholder="@lang('clientsandsuppliers::fields.website')" id="website" value="{{ $contact->website }}"
                                    type="text">
                            </div>
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <input class="form-control form-control-solid custom-height" name="tax_number"
                                    placeholder="@lang('clientsandsuppliers::fields.tax_number')" id="tax_number" value="{{ $contact->tax_number }}"
                                    type="text">
                            </div>
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <input class="form-control form-control-solid custom-height" name="commercial_register"
                                    placeholder="@lang('clientsandsuppliers::fields.commercial_register')" id="commercial_register"
                                    value="{{ $contact->commercial_register }}" type="text">
                            </div>
                            ...
                            <div class="d-flex  align-items-center ">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" style="border: 1px solid #9f9f9f;" id="point_of_sale_client"
                                        value="{{ $contact->point_of_sale_client }}" name="point_of_sale_client"
                                ...
                                <div class="col-sm">
                                    <div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
                                        <input class="form-control form-control-solid custom-input"
                                            name="contact_customLable[]" placeholder="@lang('clientsandsuppliers::fields.customLable')"
                                            value="{{ $custom->lable }}" type="text">
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
                                        <input class="form-control form-control-solid custom-input"
                                            name="contact_customValue[]" placeholder="@lang('clientsandsuppliers::fields.customValue')"
                                            value="{{ $custom->value }}" type="text">
                                    </div>
                                </div>
                            </div>
                        @endforeach
...
@section('script')
    <script>
        $(document).ready(function() {
            const canManageChartOfAccounts = @json(tenant_entitled('accounting'));
                ...
                language: {
                    noResults: function() {
                        if (!canManageChartOfAccounts) {
                            return {{ Illuminate\Support\Js::from(app()->getLocale() === 'ar' ? 'لا نتائج' : 'No results') }};
                        }
        ...
        $('.contact-card .remove-contact-card').each(function() {
