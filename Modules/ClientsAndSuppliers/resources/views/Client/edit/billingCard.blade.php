        ...
        <div class="container">
                    ...
                    <div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid ">
                        <select id="billing_country" class="form-select select-2 form-select-solid custom-input"
                            ...
                            @foreach ($countries as $country)
                                <option @if ($contact->billingAddress?->country == $country->id) selected @elseif($country->id == 111) selected  @endif value="{{ $country->id }}">
                ...
                <div class="col-sm">
                    <div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid ">
                        <input class="form-control form-control-solid custom-input"
                            value="{{ $contact->billingAddress?->street_name }}" name="billing_street_name"
            ...
            <div class="row">
                <div class="col-sm">
                    <div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid ">
                        <input class="form-control form-control-solid custom-input"
                            value="{{ $contact->billingAddress?->city }}" name="billing_city"
                ...
                <div class="col-sm">
                    <div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid ">
                        <input class="form-control form-control-solid custom-input"
                            value="{{ $contact->billingAddress?->state }}" name="billing_state"
            ...
            <div class="row">
                <div class="col-sm">
                    <div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid ">
                        <input class="form-control form-control-solid custom-input"
                            value="{{ $contact->billingAddress?->building_number }}" name="building_number"
                ...
                <div class="col-sm">
                    <div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid ">
                        <input class="form-control form-control-solid custom-input"
                            value="{{ $contact->billingAddress?->postal_code }}" name="billing_postal_code"
            ...
            @foreach ($contact->billingAddress->customInformation as $key=> $custom)
            <div class="row">
                <div class="col-sm">
                    <div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid"><input
                            class="form-control form-control-solid custom-input" name="billing_customLable[]"
                            placeholder="@lang('clientsandsuppliers::fields.customLable')" value="{{ $custom->lable}}" type="text"></div>
                </div>
                <div class="col-sm">
                    <div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid"><input
                            class="form-control form-control-solid custom-input" name="billing_customValue[]"
