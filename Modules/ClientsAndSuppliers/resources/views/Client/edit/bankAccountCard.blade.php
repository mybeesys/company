            ...
            <div class="row">
                <div class="col-sm">
                    <div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid ">
                        ...
                        <select id="bankInfo_country_bank" class="form-select select-2 form-select-solid custom-input"
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid"><input
                                    class="form-control form-control-solid custom-input" name="bankInfo_customLable[]"
                                    placeholder="@lang('clientsandsuppliers::fields.customLable')" value="{{ $custom->lable }}" type="text"></div>
                        </div>
                        <div class="col-sm">
                            <div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid"><input
                                    class="form-control form-control-solid custom-input" name="bankInfo_customValue[]"
