            ...
            <div class="contact-card">
                ...
                <div class="container">
                    <div class="row g-3">
                        <div class="col-md-12 d-flex align-items-center ">
                            <input class="form-control form-control-solid custom-input" name="client_contact_name[]"
                                  value="{{ $clientContact->name }}" placeholder="@lang('clientsandsuppliers::fields.client_contact_name')"
                                type="text">
                            <label class="fs-3 fw-semibold me-3 mb-0   "></label>
                        </div>
                        <div class="col-md-12 d-flex align-items-center ">
                        ...
                        <div class="col-md-12 d-flex align-items-center">
                            <input class="form-control form-control-solid custom-input"
                                value="{{ $clientContact->mobile_number }}" name="client_contact_mobile_number[]"
                                  placeholder="@lang('clientsandsuppliers::fields.client_contact_mobile_number')" type="text">
                            <label class="fs-3 fw-semibold me-3 mb-0   "></label>
