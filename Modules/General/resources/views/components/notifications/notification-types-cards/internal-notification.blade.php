@props(['notification_setting', 'employees', 'notification_name', 'variables', 'receiver_hint' => null])
<x-form.form-card class="mb-15 shadow" :title="__('general::general.internal_notification')" :collapsible="true"
    ...
    <x-form.input-div class="mb-10 w-100 px-2">
        <label for="{{ $notification_name }}_internal_notification_body" class="form-label">@lang('general::general.body_ar')
        </label>
