...
<x-form.form-card class="mb-15 shadow" :title="__('general::general.email_notification')" :collapsible="true"
    ...
    <x-form.input-div class="mb-10 w-100 px-2">
        <x-form.input required :errors=$errors :placeholder="__('general::general.subject_ar')" :value='$notification_setting->template["{$notification_name}_email_notification_title_ar"] ?? null'
            name="{{ $notification_name }}_email_notification_title_ar" :label="__('general::general.subject_ar')" />
    </x-form.input-div>
    ...
    <x-form.input-div class="mb-10 w-100 px-2">
        <x-form.input required :errors=$errors :placeholder="__('general::general.subject_en')" :value='$notification_setting->template["{$notification_name}_email_notification_title_en"] ?? null'
            name="{{ $notification_name }}_email_notification_title_en" :label="__('general::general.subject_en')" />
    </x-form.input-div>
    <x-form.input-div class="mb-10 w-100 px-2">
