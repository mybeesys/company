...
@section('title', __('general::lang.payment_methods'))
@section('css')
    <style>
...
@section('content')
    ...
    <div class="card card-flush">
        ...
        <x-cards.card-body class="table-responsive">
            <x-tables.table :columns=$columns model="payment_methods" module="general" />
        </x-cards.card-body>
    </div>
...
@section('script')
    ...
    <script>
        "use strict";
        let dataTable;
        const table = $('#kt_payment_methods_table');;
        const dataUrl = '{{ route('payment-methods') }}';

        $(document).ready(function() {
            if (!table.length) return;
            initDatatable();
            exportButtons([0, 1, 2, 3, 4, 5, 6], '#kt_payment_methods_table');
            handleSearchDatatable();
            handleFormFiltersDatatable();
            $('#add_payment_methods_button').on('click', function() {
