        ...
        <div class="card card-flush">
            <x-cards.card-header class="align-items-center py-5 gap-2 gap-md-5">
                <x-tables.table-header model="sell" url="create-invoice" module="sales" :addButton="false">
                    ...
                    <x-slot:export>
                        <a href="{{ route('sales-favorites') }}" class="btn btn-light-primary">
                            <i class="bi bi-star-fill fs-3 me-1"></i>@lang('menuItemLang.sales_favorites')
                        </a>
                        ...
                        <div class="btn-group">
                            @if ($Latest_event->action != '#')
                                ...
                                @enddashboardcan
                            @elseif (dashboard_can(\Modules\Sales\Support\SalesPermissions::CONVERT_QUOTATION) && dashboard_can(\Modules\Sales\Support\SalesPermissions::INVOICES_CREATE))
                            ...
                            <ul class="dropdown-menu p-5">
                                ...
                                @enddashboardcan
                                @if (dashboard_can(\Modules\Sales\Support\SalesPermissions::CONVERT_QUOTATION) && dashboard_can(\Modules\Sales\Support\SalesPermissions::INVOICES_CREATE))
                                <li>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            initDatatable();
            exportButtons([0, 1, 2, 3, 4, 5, 6, 7, 8], '#kt_sell_table');
