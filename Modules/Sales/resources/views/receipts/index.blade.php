...
@section('content')
    ...
    <div class="mb-6">
        <div class="text-muted">
            سندات العملاء مرتبطة بـ <span class="fw-semibold">فواتير المبيعات</span>، وتظهر هنا جميع عمليات التحصيل/السداد التي تمت على الفواتير.
        </div>
    </div>
        ...
        <div class="card1 h-md-100 my-5" dir="ltr">
            <div class="card-body d-flex flex-column flex-center">
                <div class="mb-2 px-20" style="place-items: center;">
                    ...
                    @dashboardcan(\Modules\Sales\Support\SalesPermissions::RECEIPTS_CREATE)
        ...
        <div class="card card-flush">
            <x-cards.card-header class="align-items-center py-5 gap-2 gap-md-5">
                <x-tables.table-header model="receipts" url="create-receipts" module="sales"
                    :addButton="dashboard_can(\Modules\Sales\Support\SalesPermissions::RECEIPTS_CREATE)">
                    <x-slot:filters>
                    </x-slot:filters>
                    <x-slot:export>
