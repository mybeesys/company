...
return new class extends Migration
{
    ...
    {
        return [
            ['name' => AccountingPermissions::RECEIVABLES_AGE_REPORT_SHOW, 'name_ar' => 'تقرير أعمار الذمم المدينة'],
            ['name' => AccountingPermissions::RECEIVABLES_AGE_REPORT_PRINT, 'name_ar' => 'تقرير أعمار الذمم المدينة'],
        ];
    }
    ...
    public function up(): void
    {
        ...
        $this->copyAssignments($table, $rolePivot, $modelPivot, AccountingPermissions::RECEIVABLES_AGING_SHOW, [
            $ids[AccountingPermissions::RECEIVABLES_AGE_REPORT_SHOW] ?? null,
        ]);
        $this->copyAssignments($table, $rolePivot, $modelPivot, AccountingPermissions::RECEIVABLES_AGING_PRINT, [
            $ids[AccountingPermissions::RECEIVABLES_AGE_REPORT_PRINT] ?? null,
        ]);
