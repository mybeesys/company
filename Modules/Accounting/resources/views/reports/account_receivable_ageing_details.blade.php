        ...
        <div class="row">
            <div class="col-md-12 col-md-offset-1">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('account-receivable-ageing-details') }}" class="row g-3 mb-4">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <label>{{ __('report::general.customer') }}</label>
                            ...
                            <div class="col-md-12 d-flex gap-2">
                                ...
                                <a class="btn btn-light-primary" href="{{ route('account-receivable-ageing-details-export-pdf', request()->query()) }}">PDF</a>
                                <a class="btn btn-light-success" href="{{ route('account-receivable-ageing-details-export-excel', request()->query()) }}">Excel</a>
                            </div>
                        </form>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="report-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>@lang('general::lang.invoice_no')</th>
                                            <th>@lang('report::general.customer')</th>
