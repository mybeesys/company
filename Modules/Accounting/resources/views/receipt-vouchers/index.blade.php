...
@section('title', __('menuItemLang.receipt_vouchers'))
@section('css')
    <style>
...
@section('script')
    ...
    <script>
        ...
        const receiptDeleteBase = '{{ url('receipt-vouchers') }}';
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.receipt-voucher-delete', function(e) {
                e.preventDefault();
                const id = $(this).data('line-id');
