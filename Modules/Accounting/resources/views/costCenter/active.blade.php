        ...
        <div class="modal-content" @if (session()->get('locale') == 'ar') dir="rtl" @endif>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-10 pt-0 pb-10">
                ...
                <form action="{{ route('change-status-cost-center') }}" method="POST">
                    ...
                    <input type="text" hidden id="cost_center_id_A" class="form-control form-control" name="cost_center_id"
                    ...
                    <div class="text-center border-0 pt-5">
                        ...
                        <span class="text-muted  fw-semibold my-10 fs-4">@lang('accounting::lang.note_active_cc')</span>
                    </div>
                    <div class="text-center py-10">
                        ...
                        <button type="submit" class="btn btn-primary"
                            ...
                            <span class="indicator-label">@lang('messages.Yes, active it!')</span>
