...
return [
    ...
    'cashier_payment_fees_table_missing' => 'The payment method fees table is missing for this tenant. Run tenant migrations and try again.',
    'cashier_payment_duplicate_method' => 'Duplicate payment method key. Change the English name or remove the duplicate row, then save.',
