...
return [
    ...
    'cashier_payment_method_not_allowed' => 'Payment method (:method) is not enabled for this branch. Add it from the cashier payment methods tab.',
    'cashier_payment_account_required' => 'Payment method ":method" has no linked account for this branch. Configure it on the branch edit page.',
