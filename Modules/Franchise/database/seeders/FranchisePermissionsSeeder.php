...
/**
 * Upserts Franchise EMS permissions without truncating other permissions.
 */
class FranchisePermissionsSeeder extends Seeder
{
    public function run(): void
    {
        $created = [];

        foreach (FranchisePermissions::definitions() as $row) {
