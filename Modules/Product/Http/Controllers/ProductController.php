...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        else if(isset($validated['id']))
        {
            ...
            $product->group_combo =  isset($validated['group_combo'])? $validated['group_combo']: $product->group_combo;
            $product->set_price = isset($validated['set_price'])? $validated['set_price'] :  $product->set_price;
            $product->use_upcharge =isset($validated['use_upcharge'])?  $validated['use_upcharge'] :  $product->use_upcharge;
            $product->linked_combo = isset($validated['linked_combo'])? $validated['linked_combo'] :  $product->linked_combo;
            $product->promot_upsell = isset($validated['promot_upsell'])? $validated['promot_upsell'] : $product->promot_upsell;
