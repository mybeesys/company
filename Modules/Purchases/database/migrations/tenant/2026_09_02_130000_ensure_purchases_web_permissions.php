...
return new class extends Migration
{
    ...
    private function permissions(): array
    {
        return [
            [
                'name' => PurchasesPermissions::DASHBOARD_SHOW,
                'name_ar' => 'لوحة المشتريات',
            ],
            [
                'name' => PurchasesPermissions::VOUCHERS_UPDATE,
                'name_ar' => 'سندات الموردين',
            ],
            [
                'name' => PurchasesPermissions::VOUCHERS_DELETE,
                'name_ar' => 'سندات الموردين',
            ],
        ];
    }
    ...
    public function up(): void
    {
        ...
        $this->copyAssignments(
            ...
            $rolePivot,
            $modelPivot,
            PurchasesPermissions::VOUCHERS_CREATE,
            [
                $ids[PurchasesPermissions::VOUCHERS_UPDATE] ?? null,
                $ids[PurchasesPermissions::VOUCHERS_DELETE] ?? null,
            ]
        );
        ...
        $this->copyAssignments(
            ...
            [
                $ids[PurchasesPermissions::DASHBOARD_SHOW] ?? null,
            ]
        );
    }
