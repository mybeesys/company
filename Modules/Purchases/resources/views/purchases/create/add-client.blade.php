    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addClientModalLabel">@lang('clientsandsuppliers::general.add_supplier')</h5>
                                    ...
                                    <div class="container">
                                        <div class="d-flex align-items-center mb-5">
                                            <label class="fs-6 fw-semibold mb-2 me-3 required"
                                                style="width: 150px;">@lang('clientsandsuppliers::fields.supplier_name')
                                            </label>
                                            <input class="form-control form-control-solid custom-height"
                                                name="client_name" required
                                                placeholder="@lang('clientsandsuppliers::fields.supplier_name') / @lang('clientsandsuppliers::fields.organization_name')"
                                                type="text">
                                        </div>
                                        <div class="d-flex align-items-center mb-5">
