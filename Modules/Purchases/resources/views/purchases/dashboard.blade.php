                ...
                <div class="col-md-3">
                    <div class="metric-card bg-primary-light">
                        ...
                        <div class="metric-content">
                            ...
                            <p>@lang('employee::main.daily_purchases')</p>
                            @if ($yesterdaySales == 0)
                ...
                <div class="col-md-3">
                    <div class="metric-card bg-success-light">
                        ...
                        <div class="metric-content">
                            ...
                            <p>@lang('sales::lang.active_suppliers')</p>
                            <span class="text-active-primary">@lang('sales::lang.this_month')</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="chart-card">
                    <div class="chart-header">
                        <h4>@lang('sales::lang.monthly_purchase_stats')</h4>
                    </div>
        ...
        <div class="recent-transactions mt-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">@lang('sales::lang.recent_purchase_transactions')</h4>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <a href="{{ url('/suppliers-receipts') }}" class="btn btn-sm btn-light-primary">
