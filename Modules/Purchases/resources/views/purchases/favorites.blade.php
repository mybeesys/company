...
@section('content')
    <div class="card card-flush">
        <x-cards.card-header class="align-items-center py-5 gap-2 gap-md-5">
            <x-tables.table-header model="purchases_favorites" url="#" module="purchases" :addButton="false">
                ...
                <x-slot:export>
                    ...
                    <x-tables.export-menu id="purchases_favorites" />
                </x-slot:export>
            </x-tables.table-header>
        </x-cards.card-header>

        <x-cards.card-body class="table-responsive">
            <x-tables.table :columns=$columns model="purchases_favorites" module="purchases" />
        </x-cards.card-body>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="transaction_type">
                                ...
                                <option value="purchases">@lang('menuItemLang.purchases')</option>
                                <option value="purchases-return">@lang('menuItemLang.purchases-return')</option>
                                <option value="purchases-order">@lang('purchases::lang.purchase order')</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="sale_date_range" readonly
                                placeholder="@lang('purchases::fields.transaction_date')">
                        </div>
                        <div class="col-md-6 mb-3">
...
@section('script')
    ...
    <script>
        "use strict";
        let dataTable;
        const table = $('#kt_purchases_favorites_table');
        const dataUrl = '{{ route('purchases-favorites') }}';
        ...
        $(document).ready(function() {
            ...
            initDatatable();
            exportButtons([0, 1, 2, 3, 4, 5, 6], '#kt_purchases_favorites_table');
