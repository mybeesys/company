...
<div class="card card-flush h-md-100">
    ...
    <div class="card-body">
        <div class="row g-5 g-xl-8">
                ...
                <a href="{{ route('purchase-payment-report') }}" class="card card-flush h-100 border border-2 border-gray-300 hover-elevate-up shadow-sm">
                    <div class="card-body d-flex p-0">
                        ...
                        <div class="flex-grow-1 p-5 d-flex align-items-center justify-content-between">
                            ...
                            <div class="report-info-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('report::purchase.purchase_payment_report_details')">
                                <i class="bi bi-question-circle text-muted fs-4"></i>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{ route('sell-payment-report') }}" class="card card-flush h-100 border border-2 border-gray-300 hover-elevate-up shadow-sm">
                    <div class="card-body d-flex p-0">
                        ...
                        <div class="flex-grow-1 p-5 d-flex align-items-center justify-content-between">
                            ...
                            <div class="report-info-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('report::purchase.sell_payment_report_details')">
                                <i class="bi bi-question-circle text-muted fs-4"></i>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{ route('product-purchase-report') }}" class="card card-flush h-100 border border-2 border-gray-300 hover-elevate-up shadow-sm">
                    <div class="card-body d-flex p-0">
                        ...
                        <div class="flex-grow-1 p-5 d-flex align-items-center justify-content-between">
                            ...
                            <div class="report-info-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('report::purchase.product_purchase_report_details')">
                                <i class="bi bi-question-circle text-muted fs-4"></i>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{ route('product-sales-report') }}" class="card card-flush h-100 border border-2 border-gray-300 hover-elevate-up shadow-sm">
                    <div class="card-body d-flex p-0">
                        ...
                        <div class="flex-grow-1 p-5 d-flex align-items-center justify-content-between">
                            ...
                            <div class="report-info-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('report::purchase.product_sales_report_details')">
                                <i class="bi bi-question-circle text-muted fs-4"></i>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
                <a href="{{ route('purchase-sell') }}" class="card card-flush h-100 border border-2 border-gray-300 hover-elevate-up shadow-sm">
                    <div class="card-body d-flex p-0">
                        <div class="report-color-line bg-blue-yellow"></div>
                        <div class="flex-grow-1 p-5 d-flex align-items-center justify-content-between">
...
<style>
    ...
    .bg-blue-yellow {
        /* Use linear-gradient to create a split background */
