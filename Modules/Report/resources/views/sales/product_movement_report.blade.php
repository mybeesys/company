...
@section('title', __('menuItemLang.product-movement-report'))
    ...
    <div class="pmr-hero">
        <div class="d-flex align-items-center gap-4 flex-wrap">
            ...
            <div class="flex-grow-1">
                <h2 class="fs-3 fw-bold text-gray-900 mb-1">@lang('menuItemLang.product-movement-report')</h2>
                <p class="text-muted fs-7 mb-0">@lang('report::purchase.product_movement_report_details')</p>
            </div>
        </div>
    </div>
        ...
        <div class="card card-flush pmr-table-card">
            <x-cards.card-header class="align-items-center py-5 gap-2 gap-md-5 border-0">
                <div class="card-title">
                    <h3 class="fs-4 fw-bold mb-0">@lang('menuItemLang.product-movement-report')</h3>
                </div>
...
<script>
    ...
    const reportBaseUrl = "{{ route('product-movement-report') }}";
