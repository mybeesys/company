                        ...
                        <form id="register_report_filter_form" method="GET"
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="col-md-4">
                                    <div class="form-group">
                                        <label
                                            for="register_report_date_range">{{ __('report::fields.date_range') }}:</label>
                                        <input type="text" name="register_report_date_range"
                                            id="register_report_date_range" class="form-control"
...
@section('script')
    ...
    <script>
        ...
        let register_report_table = $('#register_report_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ action([Modules\Report\Http\Controllers\SalesReportController::class, 'getRegisterReport']) }}',
            columns: [{
                    data: 'created_at',
                    name: 'created_at'
                },
