<div class="table-responsive">
    <table class="table align-middle table-striped table-row-bordered fs-6 gy-5" id="profit_by_invoice_table">
        <thead>
            <tr>
                <th class="min-w-10px p-3 align-middle no-border" style="text-align: inherit;">@lang('general::lang.invoice_no')</th>
