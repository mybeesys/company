...
@section('content')
    <x-cards.card>
        <x-cards.card-header class="align-items-center py-5 gap-2 gap-md-5">
            <x-tables.table-header model="role" :addButton="dashboard_can(\Modules\Employee\Support\EmployeePermissions::POS_ROLE_CREATE)" url="pos-role/create" module="employee" />
        </x-cards.card-header>
