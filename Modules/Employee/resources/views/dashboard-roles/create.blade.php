                    ...
                    data.forEach((d, index) => {
                        ...
                        if (data.length === 1) {
                            ...
                            if (index === (data.length - 1)) { // first row
                                ...
                                newTemplate.querySelectorAll('td')[0].classList.add(...
                                    borderClasses);
                                borderClasses = ['rounded-end', 'rounded-bottom-0'];
                                newTemplate.querySelectorAll('td')[4].classList.add(...
                                    borderClasses);
                            }
                            if (index === 0) { // last row
                ...
                const resetSubtable = () => {
                    ...
                    rows.forEach(r => {
                        ...
                        if (r.querySelector('[data-kt-docs-datatable-subtable="expand_row"]')) {
                            r.querySelector('[data-kt-docs-datatable-subtable="expand_row"]')
