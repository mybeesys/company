...
@endphp
<div class="modal fade" id="shift_add" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-1000px">
        <div class="modal-content">
            ...
            <div class="modal-body mx-5 pt-5">
                <form id="shift_add_form" class="form" action="#">
                    @csrf
                    <div id="kt_modal_update_shift_add_scroll">
                                ...
                                <div data-repeater-list="shift_repeater" class="d-flex flex-column gap-3">
                                    <div data-repeater-item class="d-flex align-items-center gap-3">
                                        <x-form.input :errors="$errors" required :placeholder="__('employee::fields.h_m')"
                                            name="shift_repeater[][startTime]"
                                            class="form-control-solid py-2 w-100px" readonly />
                                        <span>-</span>
                                        <x-form.input :errors="$errors" required :placeholder="__('employee::fields.h_m')"
                                            name="shift_repeater[][endTime]"
                                            class="form-control-solid py-2 w-100px" readonly />
                                        <x-form.input-div class="w-100">
                                            <x-form.select name="shift_repeater[][end_status]" required
                                                :options="$endStatusOptions" :errors="$errors" data_allow_clear="false" />
                                        </x-form.input-div>
                                        <x-form.input-div class="w-100">
                                            <x-form.select name="shift_repeater[][role]" required
