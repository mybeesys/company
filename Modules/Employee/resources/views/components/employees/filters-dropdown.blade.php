<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
    ...
    <button type="button" class="btn btn-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
        <i class="ki-outline ki-filter fs-2"></i>@lang('employee::general.filters')</button>
        ...
        <div class="px-7 py-5" data-kt-filter="form">
            ...
            <div class="mb-10">
                ...
                <select class="form-select form-select-solid fw-bold" data-kt-select2="true"
                    data-placeholder="@lang('employee::general.select_option')" data-allow-clear="true" data-kt-filter="deleted_records"
                    data-hide-search="true">
                    <option></option>
                    <option value="with_deleted_records">@lang('employee::general.with_deleted_records')</option>
                    <option value="only_deleted_records">@lang('employee::general.only_deleted_records')</option>
                </select>
            </div>
