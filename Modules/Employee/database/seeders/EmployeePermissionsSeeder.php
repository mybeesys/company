...
/**
 * Upserts Employees EMS permissions without truncating other permissions.
 */
class EmployeePermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach (array_merge(
            EmployeePermissions::definitions(),
            DashboardHubPermissions::definitions(),
            MyCompaniesPermissions::definitions(),
            ReferralsPermissions::definitions(),
        ) as $row) {
