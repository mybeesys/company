...
class ReportInvoiceService
{
    ...
    {
        // if the invoice is standard and the client is not saudi,
        // then we need to set the document type 5th position to 1 instead of zero.
        if ($document_type === DocumentType::STANDARD && $this->client && !$this->client->isSaudi()) {
            $document_type[4] = 1; # 0100100
        }
