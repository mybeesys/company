...
const EditRowCompnent = ({
    ...
    useEffect(() => {
        if (!!!menu || menu.length == 0) setMenu(defaultMenu);
    }, [defaultMenu, currentObject]);

    const saveChanges = async () => {
        try {
            setSubmitdisableButton(true);
            let r = { ...currentObject, type: type2 };
            let message = !!validateObject
                ? validateObject(currentObject)
                : "Success";
            if (message != "Success") {
                setShowAlert(true);
                Swal.fire({
                ...
                <div class="row">
                    ...
                    >
                        <div class="flex-center" style={{ display: "flex" }}>
                            <button
                                onClick={
                                    !!!submitAction ? clickSubmit : submitAction
                                }
