                    ...
                    <input
                        ...
                        value={
                            !!currentObject[field.key]
                                ? !!!field.readOnly
                                    ? currentObject[field.key]
                                    : formatDecimal(currentObject[field.key])
                                : ""
                        }
                        onChange={(e) =>
                            onBasicChange(field.key, e.target.value)
                        }
                        required={!!field.required}
                        readOnly={!!field.readOnly}
                    />
        ...
        if (field.type == "Text") {
            return (
                <>
                    ...
                    <input
                        type="text"
                        class="fform-control form-control-solid custom-height"
                        id={field.key}
                        value={currentObject[field.key]}
                        onChange={(e) =>
                            onBasicChange(field.key, e.target.value)
                    ...
                    return (
                        <>
                            ...
                            <div
                                ...
                                } col-md-${!!field.size ? field.size : 6} mb-3`}
                            >
                                {renderInput(field)}
                            </div>
                        </>
