...
const TimeTable = ({ translations, dates, onDateTimeChange }) => {
                                ...
                                <div class="row border-bottom border-dark">
                                    <form >
                                        ...
                                        footer={
                                            ...
                                            <div class="row">
                                                <div class="col-4"><span>{renderDateCell(dates, 'from_date', null, toDate(dates.to_date,'D'))}</span></div>
                                                <div class="col-4"><span>{renderDateCell(dates, 'to_date', toDate(dates.from_date, 'D'), null)}</span></div>
                                                <div class="col-1"/>
                                                <div class="col-3">
                                        ...
                                        value={dates.times} tableStyle={{ minWidth: '50rem' }} className={"custom-tree-table"}>
