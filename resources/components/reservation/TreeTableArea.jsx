...
const TreeTableModifier = ({ urlList, rootElement, translations, dir }) => {
    const listTableStatusUrl = JSON.parse(
        rootElement.getAttribute("listTableStatus-url")
    );
            ...
            <div class="card-body">
                ...
                >
                    ...
                    >
                        ...
                        <Column
                            ...
                            body={(node) =>
                                node.data.type == "table" ? (
                                    renderTextCell(node, "code", false, true)
                                ) : (
                                    <></>
                                )
                            }
                        ...
                        ></Column>
                        <Column
                            header={translations.steatingCapacity}
                            style={{ width: "10%" }}
                            body={(node) =>
                                node.data.type == "table" ? (
                                    renderNumberCell(node, "steating_capacity")
                                ) : (
                                    <></>
                                )
                            }
                        ...
                        ></Column>
                        <Column
                            header={translations.availability}
                            style={{ width: "10%" }}
                            body={(node) =>
                                node.data.type == "table" ? (
                                    renderDropDownCell(
