        ...
        <div className="unit-transfer-panel" dir={dir}>
            <div className="row g-3 mb-4">
                <div className="col-12 col-md-6 col-lg-5">
                    <label htmlFor="ingredient_main_unit" className="form-label fw-semibold">
                        {translations.Unit}
                    </label>
                    <input
                        type="text"
                        className="form-control form-control-solid custom-height"
                        id="ingredient_main_unit"
                    ...
                    cols={[
                        ...
                        },
                        {
                            ...
                            onChangeValue: (
                                ...
                                if (
                                    nodes[rowKey].data.id >= 0 &&
                                    nodes[rowKey].data.newItem == 1
                                ) {
