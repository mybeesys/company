...
const Ingredient = ({translations, dir}) => 
    {
        ...
        const handleSubmit = async (event) => {
            ...
            editedNode.data['unit_measurement'] = editedNode.data['unit_measurement'] ?   editedNode.data['unit_measurement'] : unitTypeValues[0].value ;
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold fs-3 mb-1">{translations.Ingredient}</span>
                    </h3>
                    <div class="card-toolbar">
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <a href="#" class="btn btn-primary" 
                                      onClick={() => openAddIngredient()}>{translations.Add}</a>
                            <DeleteModal
