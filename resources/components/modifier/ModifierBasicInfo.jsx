...
const ModifierBasicInfo = ({ translations, onBasicChange, currentObject, lov }) => {
  ...
  useEffect(() => {
    if (lov.modifierClasses.length > 0) {
      if (!!!currentObject.class_id) {
        ...
        currentObject['modifierClass'] = lov.modifierClasses.find(x => x.value == currentObject.class_id);
      }
    ...
    <>
      <div class="card-body" dir={dir}>
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-12">
              <label for="name_ar" class="col-form-label">{translations.modifierClass}</label>
              <Select
                    id="class_id"
                    isMulti={false}
          ...
          <div class="row">
            <div class="col-6">
              ...
              <input type="text" class="form-control form-control-solid custom-height" id="SKU" 
                ...
                placeholder="00000"
                pattern="^\d{5}$"
                onChange={(e) => onBasicChange('SKU', e.target.value)}
                ></input>
            </div>
            <div class="col-6">
          ...
          <div class="row">
            <div class="col-6">
              ...
              <input type="number" class="form-control form-control-solid custom-height" id="class" value={!!currentObject.order ? currentObject.order : ''}
                onChange={(e) => onBasicChange('order', e.target.value)}
                required></input>
            </div>
          </div>
        </div>
