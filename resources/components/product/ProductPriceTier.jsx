...
const ProductPriceTier = ({
    ...
    const handleDelete = (row) => {
        ...
        if (index != -1) currentObject.price_tiers.splice(index, 1);
                                    ...
                                    axios
                                        .get(
                                            `${
                                                ...
                                                !!nodes[rowKey].data.price
                                                    ? nodes[rowKey].data.price
                                                    : ""
                                            }`
                                        )
                                        .then((response) => {
                                            nodes[rowKey].data.price_with_tax =
                                                response.data.price_with_tax;
