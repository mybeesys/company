 ...
 return (
      <>
        ...
        <div class="col-6">
              ...
              <input type="number" min="0" step=".01" class="form-control" id="recipe_yield" value={!!currentObject.recipe_yield ? currentObject.recipe_yield : ''}
        ...
        <div class="row" style={{ paddingtop: '10px' }}>
          <div class="col-6" >
            <label class="col-form-label col-4">
              <div class="row">
                <div class="col-2">
                  <input type="checkbox" class="form-check-input" id="prep_recipe" checked={currentObject.prep_recipe}
